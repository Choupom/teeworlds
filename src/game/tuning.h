...
MACRO_TUNING_PARAM(FlashGrenadeCurvature, flashgrenade_curvature, 9.0f)
MACRO_TUNING_PARAM(FlashGrenadeSpeed, flashgrenade_speed, 800.0f)
MACRO_TUNING_PARAM(FlashGrenadeLifetime, flashgrenade_lifetime, 7.0f)
