...
set_particles = SpriteSet("particles", image_particles, 12, 8)
...
container.sprites.Add(Sprite("part_backflash01", set_particles, 5,0,3,3))
container.sprites.Add(Sprite("part_backflash02", set_particles, 4,3,4,4))
container.sprites.Add(Sprite("part_foreflash01", set_particles, 8,0,4,4))
container.sprites.Add(Sprite("part_foreflash02", set_particles, 8,4,4,4))
